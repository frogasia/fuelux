...
define('fuelux/all',['require','jquery','fuelux/checkbox','fuelux/combobox','fuelux/datagrid','fuelux/datepicker','fuelux/intelligent-dropdown','fuelux/pillbox','fuelux/radio','fuelux/scheduler','fuelux/search','fuelux/spinner','fuelux/select','fuelux/tree','fuelux/wizard'],function (require) {
	require('jquery');
